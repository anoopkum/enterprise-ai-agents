output "endpoint"             { value = "https://${var.location}.api.azureml.ms/rp/workspaces/subscriptions/placeholder/resourceGroups/placeholder/providers/Microsoft.MachineLearningServices/workspaces/${azurerm_machine_learning_workspace.project.name}" }
